 ...
 */
class StatsRepository(private val td: TdSender) : StatsFacade {

    /** Aggregated cellular + Wi-Fi + roaming traffic since TDLib started recording. */
    override suspend fun networkUsage(): NetworkUsage {
    ...
    override suspend fun resetTrafficStats(): Result<Unit> = runCatching {
