...
sealed interface AuthStage {
     ...
     *     channel that fires besides Fragment (tdlib/td#2310: third-party type/next_type
     *     can be ONLY TelegramMessage, Fragment, or null — SMS is reserved for official
     *     mobile apps). Drives a helper line telling the user the code arrives in Telegram
     *     on another signed-in device, NOT by SMS.
     */
    data class WaitCode(
