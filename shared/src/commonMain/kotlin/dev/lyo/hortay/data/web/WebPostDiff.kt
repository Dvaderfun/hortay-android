 ...
 * - **CDN URL rotation.** t.me/s/ refreshes media URL tokens hourly. We compare the path's last
 *   segment (filename) only, ignoring query string.
 * - **View-count / reaction churn.** Live state, not edits — ignored.
 *
