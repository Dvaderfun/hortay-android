...
import hortay.shared.generated.resources.archive_row_kind_deleted
import hortay.shared.generated.resources.archive_row_kind_edited
...
fun ArchiveRow(snapshot: PostSnapshot, onClick: () -> Unit, modifier: Modifier = Modifier) {
    ...
    Card(
        ...
        Column(Modifier.padding(12.dp)) {
            Text(
                if (isDeleted) {
                    stringResource(Res.string.archive_row_kind_deleted)
                } else {
                    stringResource(Res.string.archive_row_kind_edited)
                },
