...
import hortay.shared.generated.resources.archive_empty_enabled
import hortay.shared.generated.resources.archive_filter_all
import hortay.shared.generated.resources.archive_filter_deleted
import hortay.shared.generated.resources.archive_filter_edited
import hortay.shared.generated.resources.archive_purged
import hortay.shared.generated.resources.archive_scope_all
import hortay.shared.generated.resources.archive_scope_comments
import hortay.shared.generated.resources.archive_scope_posts
import hortay.shared.generated.resources.archive_screen_title
import hortay.shared.generated.resources.archive_search_placeholder
    ...
    Scaffold(
        ...
        Column(Modifier.padding(padding)) {
            OutlinedTextField(
                ...
                placeholder = { Text(stringResource(Res.string.archive_search_placeholder)) },
                modifier = Modifier
                    .fillMaxWidth()
            ...
            FlowRow(
                ...
                FilterChip(
                    ...
                    label = { Text(stringResource(Res.string.archive_scope_all)) },
                )
                FilterChip(
                    selected = filter.scope == ArchiveScope.POSTS,
                    onClick = { viewModel.setScope(ArchiveScope.POSTS) },
                    label = { Text(stringResource(Res.string.archive_scope_posts)) },
                )
                FilterChip(
                    selected = filter.scope == ArchiveScope.COMMENTS,
                    onClick = { viewModel.setScope(ArchiveScope.COMMENTS) },
                    label = { Text(stringResource(Res.string.archive_scope_comments)) },
                )
            }
            if (snapshots.isEmpty()) {
                Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                    Text(
                        stringResource(Res.string.archive_empty_enabled),
                ...
                LazyColumn {
                    items(snapshots, key = { it.id }) { snap ->
                        val purgedMessage = stringResource(Res.string.archive_purged)
